# filename:single_txt2xml.py
# author:李昕尉
# created:2022.11.9
# function:将单个江苏省史料txt格式文本构建为规范xml格式。
#          输入.txt文件路径：./江苏省史料（TXT格式）/1912.txt
#          输出.xml文件定向到代码运行同级目录

file_path = r'D:\OneDrive - 南京大学\001事件抽取\江苏省史料xml\江苏省史料（TXT格式）\1912.txt'
year = 1912
fi = open(file_path, 'r', encoding='utf-8')
fo = open(f"{year}.xml", "w", encoding='utf-8')
